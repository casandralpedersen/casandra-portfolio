  ...
  return (
    <main className="relative overflow-hidden bg-[var(--color-base)]">
      <section className="relative min-h-[calc(100svh-64px)] px-6 pt-10 pb-20 sm:px-10">
        <h1
          aria-hidden="true"
          className="pointer-events-none absolute -left-10 top-[20%] -rotate-6 whitespace-nowrap text-[clamp(6rem,26vw,18rem)] leading-none text-[var(--color-burgundy)]/10"
        ...
        <div className="relative z-10 grid gap-12 pt-6 lg:grid-cols-[1fr_0.85fr] lg:items-center lg:pt-0">
          ...
          <motion.div
            ...
            className="relative mx-auto w-[260px] bg-[#fffdf5] p-3 shadow-xl sm:w-[320px]"
          >
